...
```{r, fig.width=7, fig.height=12, eval=T}
...
```{r eccentricity, message=FALSE, fig.width=8, fig.height=10}
...
```{r plot eccentricity threshold, message=FALSE, fig.width=8, fig.height=10}
